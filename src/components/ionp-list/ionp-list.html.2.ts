/**
 * [14:22:59]  ngc started ...
 * [14:23:01]  ionic-app-script task: "build"
 * [14:23:01]  Error: Error encountered resolving symbol values statically. Expression form not supported (position 149:33
            in the original .ts file), resolving symbol IonpListComponentTemplate in
            F:/ionic/ionic3-platform/src/components/ionp-list/ionp-list.html.ts, resolving symbol IonpListComponent in
            F:/ionic/ionic3-platform/src/components/ionp-list/ionp-list.component.ts, resolving symbol IonpListComponent
            in F:/ionic/ionic3-platform/src/components/ionp-list/ionp-list.component.ts
 *
 * ngc 模式不支持单独的变量输出，调整为静态类输出           
 */
export class IonpListComponentTemplate {
